<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="outOrderList" style="width: 100%">
      ...
      <el-table-column label="商品编码" v-if="outOrderType==='production'" align="center" prop="matCode" width="120" />
      <el-table-column label="商品名称" v-if="outOrderType==='production'" align="center" prop="matName" width="180" />
      ...
      <el-table-column label="货位" align="center" prop="workshopName" width="120" />
