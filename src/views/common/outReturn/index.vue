<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="货位" prop="workshopCode">
        <el-select v-model="queryParams.workshopCode" placeholder="请选择货位">
          <el-option
    ...
    <el-table v-loading="loading" :data="outReturnList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="货位" align="center" prop="workshopName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="1200px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="货位" prop="workshopCode">
              <el-select v-model="form.workshopCode" disabled placeholder="请选择货位">
                <el-option
                  v-for="item in workshopList"
                  :key="item.workshopCode"
                  :label="item.workshopName"
      ...
      <el-table v-loading="loading" :data="outReturnDetailList">
        <el-table-column label="商品编码" fixed align="center" prop="matCode" width="120" />
        <el-table-column label="商品名称" fixed align="center" prop="matName" width="180" />
    ...
    <el-dialog class="detail-dialog" :title="'出库退货单详情'" :visible.sync="outOrderReturnDetailOpen" width="1200px" append-to-body :close-on-click-modal="false">
      ...
      <el-table class="detail-table" :data="outReturnDetailList" style="width: 100%">
        <el-table-column label="商品编码" align="center" prop="matCode" width="120" />
        <el-table-column label="商品名称" align="center" prop="matName" width="180" />
        <el-table-column label="财务编码" align="center" prop="fdCode" width="120" />
        <el-table-column label="图号" align="center" prop="figNum" width="120" />
