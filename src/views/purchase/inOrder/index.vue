<template>
  <div class="app-container">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="选择商品标签">
              <el-button size="small" type="success" icon="el-icon-search" @click="openSelectMatLabelDialog">商品标签清单</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    <el-dialog :title="'选择商品标签'" :visible.sync="selectMatLabelOpen" width="1200px" append-to-body :close-on-click-modal="false">
