<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="matList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品描述" align="center" prop="matName" />
      <el-table-column label="财务编码" align="center" prop="fdCode" />
      <el-table-column label="图号" align="center" prop="figNum" />
      <el-table-column label="商品组" align="center" prop="matGroupName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="商品编码" prop="matCode">
          <el-input v-model="form.matCode" placeholder="请输入商品编码" :disabled="form.matId != null"/>
        </el-form-item>
        <el-form-item label="商品描述" prop="matName">
          <el-input v-model="form.matName" placeholder="请输入商品描述" />
        </el-form-item>
        <el-form-item label="财务编码" prop="fdCode">
        ...
        <el-form-item label="商品组" prop="matGroup">
          <el-select v-model="form.matGroup" placeholder="请选择商品组">
            <el-option
              v-for="item in groupList"
              :key="item.groupCode"
              :label="item.groupName"
        ...
        <el-form-item label="分类" prop="matClass">
          <el-select v-model="form.matClass" placeholder="请选择商品分类">
            <el-option
              v-for="item in classList"
              :key="item.classCode"
              :label="item.className"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除商品主数据编号为"' + matIds + '"的数据项？').then(function() {
