<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="货位编码" prop="workshopCode">
        <el-input
      ...
      <el-form-item label="货位名称" prop="workshopName">
        <el-input
    ...
    <el-table v-loading="loading" :data="workshopList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="货位编码" align="center" prop="workshopCode" />
      <el-table-column label="货位名称" align="center" prop="workshopName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="货位编码" prop="workshopCode">
          <el-input v-model="form.workshopCode" placeholder="请输入货位编码" />
        </el-form-item>
        <el-form-item label="货位名称" prop="workshopName">
          <el-input v-model="form.workshopName" placeholder="请输入货位名称" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除货位编号为"' + workshopIds + '"的数据项？').then(function() {
